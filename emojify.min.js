...
},{}],2:[function(i,e){function s(i,e,s){for(;i.length<s;)i=e+i;return i}function a(){l.forEach(function(i){p.create(void 0,function(e){var s,a=i.emoji;return i.aliases.forEach(function(i){e.add_alias(i)}),a&&(e.add_unicode_alias(a),s=n(r(a).filter(function(i){return i!=g}).concat([g])),a!==s&&e.add_unicode_alias(s)),i.tags.forEach(function(i){e.add_tag(i)}),e})})}var o,t=i("punycode"),r=t.ucs2.decode,n=t.ucs2.encode,l=i("./emoji.json"),c={},d={},g=65039,Character=function(i){this.aliases=i?[i]:[],this.unicode_aliases=[],Object.defineProperty(this,"name",{enumerable:!0,get:function(){return this.aliases[0]}}),Object.defineProperty(this,"raw",{enumerable:!0,get:function(){return this.unicode_aliases[0]}}),Object.defineProperty(this,"custom",{enumerable:!0,get:function(){return!this.raw}}),this.tags=[],Object.defineProperty(this,"image_filename",{enumerable:!0,get:function(){return this.custom?this.name+".png":"unicode/"+this.hex_inspect().replace("-"+g.toString(16),"")+".png"}})};Character.prototype.toString=function(){var i=this.custom?"":this.hex_inspect();return"<Emoji:"+this.name+" ("+i+")> "+JSON.stringify(this)},Character.prototype.add_alias=function(i){this.aliases.push(i)},Character.prototype.add_unicode_alias=function(i){this.unicode_aliases.push(i)},Character.prototype.add_tag=function(i){this.tags.push(i)},Character.prototype.hex_inspect=function(){return r(this.raw).map(function(i){return s(i.toString(16),"0",4)}).join("-")};var p={create:function(i,e){var s=new Character;return this.all.push(this.edit_emoji(s,e)),s},edit_emoji:function(i,e){return e&&(i=e(i)),i.aliases.forEach(function(e){c[e]=i}),i.unicode_aliases.forEach(function(e){d[e]=i}),i},get all(){return void 0!==o?o:(o=[],a(),o)},find_by_alias:function(i){return this.all&&void 0,c[i]},find_by_unicode:function(i){return this.all&&void 0,d[i]}};e.exports=p},{"./emoji.json":1,punycode:3}],3:[function(e,s,a){(function(e){!function(o){function t(i){throw RangeError(F[i])}function r(i,e){for(var s=i.length;s--;)i[s]=e(i[s]);return i}function n(i,e){return r(i.split(P),e).join(".")}function l(i){for(var e,s,a=[],o=0,t=i.length;t>o;)e=i.charCodeAt(o++),e>=55296&&56319>=e&&t>o?(s=i.charCodeAt(o++),56320==(64512&s)?a.push(((1023&e)<<10)+(1023&s)+65536):(a.push(e),o--)):a.push(e);return a}function c(i){return r(i,function(i){var e="";return i>65535&&(i-=65536,e+=M(i>>>10&1023|55296),i=56320|1023&i),e+=M(i)}).join("")}function d(i){return 10>i-48?i-22:26>i-65?i-65:26>i-97?i-97:v}function g(i,e){return i+22+75*(26>i)-((0!=e)<<5)}function p(i,e,s){var a=0;for(i=s?L(i/C):i>>1,i+=L(i/e);i>J*q>>1;a+=v)i=L(i/J);return L(a+(J+1)*i/(i+z))}function m(i){var e,s,a,o,r,n,l,g,m,j,h=[],u=i.length,b=0,f=O,w=E;for(s=i.lastIndexOf(A),0>s&&(s=0),a=0;s>a;++a)i.charCodeAt(a)>=128&&t("not-basic"),h.push(i.charCodeAt(a));for(o=s>0?s+1:0;u>o;){for(r=b,n=1,l=v;o>=u&&t("invalid-input"),g=d(i.charCodeAt(o++)),(g>=v||g>L((y-b)/n))&&t("overflow"),b+=g*n,m=w>=l?x:l>=w+q?q:l-w,!(m>g);l+=v)j=v-m,n>L(y/j)&&t("overflow"),n*=j;e=h.length+1,w=p(b-r,e,0==r),L(b/e)>y-f&&t("overflow"),f+=L(b/e),b%=e,h.splice(b++,0,f)}return c(h)}function j(i){var e,s,a,o,r,n,c,d,m,j,h,u,b,f,w,_=[];for(i=l(i),u=i.length,e=O,s=0,r=E,n=0;u>n;++n)h=i[n],128>h&&_.push(M(h));for(a=o=_.length,o&&_.push(A);u>a;){for(c=y,n=0;u>n;++n)h=i[n],h>=e&&c>h&&(c=h);for(b=a+1,c-e>L((y-s)/b)&&t("overflow"),s+=(c-e)*b,e=c,n=0;u>n;++n)if(h=i[n],e>h&&++s>y&&t("overflow"),h==e){for(d=s,m=v;j=r>=m?x:m>=r+q?q:m-r,!(j>d);m+=v)w=d-j,f=v-j,_.push(M(g(j+w%f,0))),d=L(w/f);_.push(M(g(d,0))),r=p(s,b,a==o),s=0,++a}++s,++e}return _.join("")}function h(i){return n(i,function(i){return S.test(i)?m(i.slice(4).toLowerCase()):i})}function u(i){return n(i,function(i){return I.test(i)?"xn--"+j(i):i})}var b="object"==typeof a&&a,f="object"==typeof s&&s&&s.exports==b&&s,w="object"==typeof e&&e;(w.global===w||w.window===w)&&(o=w);var _,k,y=2147483647,v=36,x=1,q=26,z=38,C=700,E=72,O=128,A="-",S=/^xn--/,I=/[^ -~]/,P=/\x2E|\u3002|\uFF0E|\uFF61/g,F={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)","invalid-input":"Invalid input"},J=v-x,L=Math.floor,M=String.fromCharCode;if(_={version:"1.2.4",ucs2:{decode:l,encode:c},decode:m,encode:j,toASCII:u,toUnicode:h},"function"==typeof i&&"object"==typeof i.amd&&i.amd)i("punycode",function(){return _});else if(b&&!b.nodeType)if(f)f.exports=_;else for(k in _)_.hasOwnProperty(k)&&(b[k]=_[k]);else o.punycode=_}(this)}).call(this,"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}]},{},[2])(2)});